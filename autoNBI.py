...
def main():
    ...
    usage = ('Usage: %prog --source/-s <path>\n'
             ...
             '    Run non-interactively, use Mojave installer app as source:\n'
             '    $ ./AutoNBI.py -s /Volumes/Disk/Install OS X Mojave.app -d'
             ' ~/BuildRoot -n MyNBI -a\n\n'
             ...
             ' -f Packages -a\n\n'
             '    Run non-interactively, use the Mojave installer as source,\n'
             '    replace Packages folder, enable the NBI, use index 6667 and\n'
             '    enable support for MacBookPro12,1 models only:\n'
             '    $ ./AutoNBI.py --source /Applications/Install\ OS\ X\ Mojave.app\n'
             '                   --destination /tmp \\\n'
             '                   --name Imagr \\\n'
             '                   --folder Packages \\\n'
             '                   --auto --default --enable \\\n'
